                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.services.update', $service->id) }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <img src="/images/{{ $service->img }}" width="60" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="service_different_uz"
                                            value="{{ $service->service_different_uz }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="service_different_en"
                                            value="{{ $service->service_different_en }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="service_different_ru"
                                            value="{{ $service->service_different_ru }}">
                                    </div>
                                </div>
